...
<body>
   ...
   <main>
                  ...
                  <div class="swiper-slide">
                     <div class="row align-items-center">
                        ...
                        <div class="col-5 text-start bannerText">
                           ...
                           <a href="shop.php"><button>Shop Now <iconify-icon
      ...
      <section id="video">
         <div class="container">
            <div class="row">
               <img class="img-fluid vid" src="./assets/img/Video.png" alt="">
               <div class="video">
                  <video id="video-m" src="./assets/img/Creative IT Institute 16 Years of Grace Coming Soon!.mp4"
